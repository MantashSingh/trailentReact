      ...
      <ScrollView style={{flex: 1}} showsVerticalScrollIndicator={false}>
        <View style={onBoardingStyles.mainView}>
          <View style={onBoardingStyles.subView}>
            <Text style={onBoardingStyles.heading}>Fill out forms in </Text>
            <Text style={onBoardingStyles.heading}>seconds!</Text>
            <Text style={onBoardingStyles.subHeading}>
              With Trailant filling digital forms is easy
            </Text>
          </View>
          <Image
            resizeMode="contain"
            source={imagePath.ic_onboard2}
        ...
        <TouchableOpacity
          style={commonStyles.button}
          onPress={() =>
            moveToNewScreen(navigationStrings.RETURNING_USER_PASSPHRASE, {returning: true})
          }>
